...
public class UserInfoClient {
	...
	public static void main(String[] args) {
		...
		WebResource allResource = resource.path("rest").path(PATH_ALL);
		System.out.println("Client Response \n" + getClientResponse(allResource));
		System.out.println("Response \n" + getResponse(allResource) + "\n\n");
	...
	/**
	 * Returns client response. e.g : GET http://localhost:8080/RESTfulWS/rest/UserInfoService/name/Pavithra returned a response status of
	 * 200 OK
	 *
	 * @param service
	 * @return
